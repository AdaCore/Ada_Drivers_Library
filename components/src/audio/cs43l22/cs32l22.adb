...
package body cs32l22 is

   --  this address is from w8994, I think I need to
   --  change it to the address for cs32l22
   cs32l22_CHIPID_ADDR      : constant := 16#00#;
   ...
   function Read_ID (This : in out cs32l22_Device) return Unsigned_16 is
   begin
      return This.I2C_Read (cs32l22_CHIPID_ADDR);
   end Read_ID;
   ...
   procedure Play (This : in out cs32l22_Device) is
   begin
   ...
   procedure Pause (This : in out cs32l22_Device) is
   begin
   ...
   procedure Resume (This : in out cs32l22_Device) is
   begin
      This.Set_Mute (Mute_Off);
   end Resume;
   ...
   procedure Stop (This : in out cs32l22_Device; Cmd : Stop_Mode) is
   begin
   ...
   procedure Set_Mute (This : in out cs32l22_Device; Cmd : Mute) is
   begin
      if Output_Enabled then
         case Cmd is
            when Mute_On =>
   ...
   procedure Reset (This : in out cs32l22_Device) is
   begin
      I2C_Write (This, 16#0000#, 16#0000#);
      Output_Enabled := False;
      Input_Enabled  := False;
