...
package SAM.Device is
   ...
   PORTD_Internal : aliased Port_Internal
     with Import, Address => System'To_Address (16#41008000# + 16#180#);
   PORTD : aliased Port_Controller (PORTD_Internal'Access);

   PD00 : aliased GPIO_Point (PORTD'Access, 0);
   PD01 : aliased GPIO_Point (PORTD'Access, 1);
   PD02 : aliased GPIO_Point (PORTD'Access, 2);
   PD03 : aliased GPIO_Point (PORTD'Access, 3);
   PD04 : aliased GPIO_Point (PORTD'Access, 4);
   PD05 : aliased GPIO_Point (PORTD'Access, 5);
   PD06 : aliased GPIO_Point (PORTD'Access, 6);
   PD07 : aliased GPIO_Point (PORTD'Access, 7);
   PD08 : aliased GPIO_Point (PORTD'Access, 8);
   PD09 : aliased GPIO_Point (PORTD'Access, 9);
   PD10 : aliased GPIO_Point (PORTD'Access, 10);
   PD11 : aliased GPIO_Point (PORTD'Access, 11);
   PD12 : aliased GPIO_Point (PORTD'Access, 12);
   PD13 : aliased GPIO_Point (PORTD'Access, 13);
   PD14 : aliased GPIO_Point (PORTD'Access, 14);
   PD15 : aliased GPIO_Point (PORTD'Access, 15);
   PD16 : aliased GPIO_Point (PORTD'Access, 16);
   PD17 : aliased GPIO_Point (PORTD'Access, 17);
   PD18 : aliased GPIO_Point (PORTD'Access, 18);
   PD19 : aliased GPIO_Point (PORTD'Access, 19);
   PD20 : aliased GPIO_Point (PORTD'Access, 20);
   PD21 : aliased GPIO_Point (PORTD'Access, 21);
   PD22 : aliased GPIO_Point (PORTD'Access, 22);
   PD23 : aliased GPIO_Point (PORTD'Access, 23);
   PD24 : aliased GPIO_Point (PORTD'Access, 24);
   PD25 : aliased GPIO_Point (PORTD'Access, 25);
   PD26 : aliased GPIO_Point (PORTD'Access, 26);
   PD27 : aliased GPIO_Point (PORTD'Access, 27);
   PD28 : aliased GPIO_Point (PORTD'Access, 28);
   PD29 : aliased GPIO_Point (PORTD'Access, 29);
   PD30 : aliased GPIO_Point (PORTD'Access, 30);
   PD31 : aliased GPIO_Point (PORTD'Access, 31);
