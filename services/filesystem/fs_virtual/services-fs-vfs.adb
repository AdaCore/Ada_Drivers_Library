...
package body Services.FS.VFS is
   ...
   is
      Ret : VFS_Private_Cursor;
   begin
      Ret.Current := This.FS.Mount_Points;

      return Ret;
   end Directory_Iter_First;
   ...
   overriding function Directory_Iter_Next
     (This : VFS_Directory_Handle;
      ...
      return Directory_Private_Cursor'Class
   is
      Curs : constant VFS_Private_Cursor := VFS_Private_Cursor (C);
   begin
      if Curs.Current = null then
         raise Constraint_Error with "No more elements";
      end if;

      Curs.Current := Curs.Current.Next;
   end Directory_Iter_Next;
   ...
   end Directory_Iter_Has_Element;
