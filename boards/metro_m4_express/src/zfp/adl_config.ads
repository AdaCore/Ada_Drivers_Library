...
package ADL_Config is
   Vendor                         : constant String  := "Microchip";         -- From board definition
   ...
   Device_Name                    : constant String  := "ATSAMD51J19A";      -- From board definition
   Device_Family                  : constant String  := "SAMD51";            -- From board definition
   ...
   Board                          : constant String  := "Metro_M4_Express";  -- From command line
