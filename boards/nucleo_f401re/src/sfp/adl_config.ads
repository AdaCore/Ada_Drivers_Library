...
package ADL_Config is
   ...
   Device_Name                    : constant String  := "STM32F401RE";     -- From board definition
   ...
   Runtime_Name                   : constant String  := "ravenscar-sfp-nucleo_f401re"; -- From default value
   ...
   Board                          : constant String  := "NUCLEO_F401RE";     -- From command line
   ...
   Runtime_Name_Suffix            : constant String  := "nucleo_f401re";           -- From board definition
