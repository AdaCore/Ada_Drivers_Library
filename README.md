...
(BSD) license, specifically, the "Modified BSD license", also known as the
"3-clause BSD license".  As such, and within the conditions required by the
license, the files are available both for proprietary ("commercial") and
non-proprietary use.
