...
package STM32_SVD.RCC is
   ...
   subtype AHB2RSTR_CRYPRST_Field is STM32_SVD.Bit;

   subtype AHB2RSTR_HSAHRST_Field is STM32_SVD.Bit;
   ...
   subtype AHB3RSTR_QSPIRST_Field is STM32_SVD.Bit;
   ...
   subtype APB1RSTR_SPDIFRXRST_Field is STM32_SVD.Bit;
   ...
   subtype APB2RSTR_SDMMC1RST_Field is STM32_SVD.Bit;
   ...
   subtype APB2RSTR_SAI2RST_Field is STM32_SVD.Bit;
   ...
   subtype AHB2ENR_CRYPEN_Field is STM32_SVD.Bit;

   subtype AHB2ENR_HASHEN_Field is STM32_SVD.Bit;
   ...
   subtype AHB3ENR_QSPIEN_Field is STM32_SVD.Bit;
   ...
   subtype APB1ENR_LPTMI1EN_Field is STM32_SVD.Bit;
   ...
   subtype APB1ENR_SPDIFRXEN_Field is STM32_SVD.Bit;
   ...
   subtype APB2ENR_SDMMC1EN_Field is STM32_SVD.Bit;
   ...
   subtype APB2ENR_SAI2EN_Field is STM32_SVD.Bit;
   ...
   subtype AHB2LPENR_CRYPLPEN_Field is STM32_SVD.Bit;

   subtype AHB2LPENR_HASHLPEN_Field is STM32_SVD.Bit;
   ...
   subtype AHB3LPENR_QSPILPEN_Field is STM32_SVD.Bit;
   ...
   subtype APB1LPENR_LPTIM1LPEN_Field is STM32_SVD.Bit;
   ...
   subtype APB1LPENR_SPDIFRXLPEN_Field is STM32_SVD.Bit;
   ...
   subtype APB2LPENR_SDMMC1LPEN_Field is STM32_SVD.Bit;
   ...
   subtype APB2LPENR_SAI2LPEN_Field is STM32_SVD.Bit;
   ...
   subtype PLLSAICFGR_PLLSAIP_Field is STM32_SVD.UInt2;
   ...
   subtype DKCFGR1_PLLI2SDIV_Field is STM32_SVD.UInt5;

   subtype DKCFGR1_PLLSAIDIVQ_Field is STM32_SVD.UInt5;

   subtype DKCFGR1_PLLSAIDIVR_Field is STM32_SVD.UInt2;

   subtype DKCFGR1_SAI1SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR1_SAI2SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR1_TIMPRE_Field is STM32_SVD.Bit;
   ...
   type DKCFGR1_Register is record
      ...
      --  unspecified
      Reserved_13_15 : STM32_SVD.UInt3 := 16#1#;
      ...
      --  unspecified
      Reserved_25_31 : STM32_SVD.UInt7 := 16#10#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DKCFGR2_USART1SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_USART2SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_USART3SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_UART4SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_UART5SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_USART6SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_UART7SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_UART8SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_I2C1SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_I2C2SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_I2C3SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_I2C4SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_LPTIM1SEL_Field is STM32_SVD.UInt2;

   subtype DKCFGR2_CECSEL_Field is STM32_SVD.Bit;

   subtype DKCFGR2_CK48MSEL_Field is STM32_SVD.Bit;

   subtype DKCFGR2_SDMMCSEL_Field is STM32_SVD.Bit;
   ...
   type DKCFGR2_Register is record
      ...
      --  unspecified
      Reserved_29_31 : STM32_SVD.UInt3 := 16#1#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
