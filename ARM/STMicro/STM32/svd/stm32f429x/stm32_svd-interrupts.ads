...
package STM32_SVD.Interrupts is
   ...
   FLASH_IRQ_Interrupt: constant Interrupt_ID := 6;
   ...
   FMC_IRQ_Interrupt: constant Interrupt_ID := 50;
   ...
   RNG_IRQ_Interrupt: constant Interrupt_ID := 82;

   UART7_IRQ_Interrupt: constant Interrupt_ID := 84;

   UART8_IRQ_Interrupt: constant Interrupt_ID := 85;

   SPI4_IRQ_Interrupt: constant Interrupt_ID := 86;

   SPI5_IRQ_Interrupt: constant Interrupt_ID := 87;

   SPI6_IRQ_Interrupt: constant Interrupt_ID := 88;
