...
package STM32_SVD.RCC is
   ...
   subtype AHB3RSTR_FSMCRST_Field is STM32_SVD.Bit;
   ...
   type AHB1ENR_Register is record
      ...
      --  unspecified
      Reserved_19_20 : STM32_SVD.UInt2 := 16#2#;
      --  DMA1 clock enable
   ...
   subtype AHB3ENR_FSMCEN_Field is STM32_SVD.Bit;
   ...
   subtype AHB3LPENR_FSMCLPEN_Field is STM32_SVD.Bit;
   ...
   subtype PLLI2SCFGR_PLLI2SNx_Field is STM32_SVD.UInt9;
   subtype PLLI2SCFGR_PLLI2SRx_Field is STM32_SVD.UInt3;
   ...
   type PLLI2SCFGR_Register is record
      ...
      --  unspecified
      Reserved_15_27 : STM32_SVD.UInt13 := 16#0#;
