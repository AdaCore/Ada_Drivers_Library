...
package STM32_SVD.RCC is
   ...
   subtype CR_PLLSAION_Field is STM32_SVD.Bit;

   subtype CR_PLLSAIRDY_Field is STM32_SVD.Bit;
   ...
   subtype PLLCFGR_PLLR_Field is STM32_SVD.UInt3;
   ...
   subtype APB2RSTR_DSIRST_Field is STM32_SVD.Bit;
   ...
   subtype APB2ENR_DSIEN_Field is STM32_SVD.Bit;
   ...
   subtype APB2LPENR_DSILPEN_Field is STM32_SVD.Bit;
   ...
   subtype BDCR_LSEMOD_Field is STM32_SVD.Bit;
   ...
   subtype DCKCFGR_PLLIS2DIVQ_Field is STM32_SVD.UInt5;
   ...
   subtype DCKCFGR_MSEL_Field is STM32_SVD.Bit;

   subtype DCKCFGR_SDMMCSEL_Field is STM32_SVD.Bit;

   subtype DCKCFGR_DSISEL_Field is STM32_SVD.Bit;
   ...
   type DCKCFGR_Register is record
      ...
      --  unspecified
      Reserved_25_26 : STM32_SVD.UInt2 := 16#0#;
