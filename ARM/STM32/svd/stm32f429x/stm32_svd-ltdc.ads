...
package STM32_SVD.LTDC is
   ...
   subtype SSCR_HSW_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype BPCR_AHBP_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype AWCR_AAW_Field is Interfaces.Bit_Types.UInt12;
   ...
   subtype TWCR_TOTALW_Field is Interfaces.Bit_Types.UInt12;
