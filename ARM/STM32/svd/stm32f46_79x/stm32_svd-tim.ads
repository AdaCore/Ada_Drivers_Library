...
package STM32_SVD.TIM is
   ...
   subtype BDTR_DTG_Field is Interfaces.Bit_Types.Byte;
   ...
   subtype OR_ITR1_RMP_Field is Interfaces.Bit_Types.UInt2;

   --  TIM5 option register
   type OR_Register is record
      --  unspecified
      Reserved_0_9   : Interfaces.Bit_Types.UInt10 := 16#0#;
      --  Timer Input 4 remap
   ...
   subtype OR_IT4_RMP_Field is Interfaces.Bit_Types.UInt2;
   ...
   subtype CCMR1_Input_IC1F_Field_1 is Interfaces.Bit_Types.UInt3;
   subtype CCMR1_Input_IC2F_Field_1 is Interfaces.Bit_Types.UInt3;
   ...
   subtype OR_RMP_Field is Interfaces.Bit_Types.UInt2;
